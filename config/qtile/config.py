...
myBrowser = "firefox"
tdrop="tdrop -h 70% -w 60% -x 20% -y 15%"
# The Qtile config file location
myConfig = "/home/collpp/.config/qtile/config.py"
# scrathpad.ScratchPad().init_scratchpad()
# scrathpad.DropDown().init_dropdown_keybindings()
...
keys = [
         ...
         Key([],"XF86AudioMute",
             ...
             desc="Toggle Mute"),
         Key([],"XF86AudioNext",
             lazy.spawn("mocp -f ; sleep 1 ; name=$(mocp -Q %file) ; notify-send $name"),
             desc="Next Song MOCP"),
         Key([],"XF86AudioPrev",
             lazy.spawn("mocp -r ; sleep 1 ;name=$(mocp -Q %file); notify-send $name"),
